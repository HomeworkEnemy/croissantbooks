jQuery(document).ready(function($) {
    'use strict';
    var this_obj = pest_control_treatment_plugin_activate_plugin;
    ...
    $(document).on('click', '.pest-control-treatment-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message pest-control-treatment-plugin-install');
                button.addClass('button-primary pest-control-treatment-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.pest-control-treatment-recommended-plugins .pest-control-treatment-activation-note').css('display','block');
    ...
    $(document).on('click', '.pest-control-treatment-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .pest-control-treatment-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .pest-control-treatment-recommended-plugins').css('display','none');
    });
