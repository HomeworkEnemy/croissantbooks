...
if ( ! class_exists( 'Pest_Control_Treatment_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Pest_Control_Treatment_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Pest_Control_Treatment_WPTT_WebFont_Loader( $url );
