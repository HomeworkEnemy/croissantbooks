...
class Pest_Control_Treatment_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'pest-control-treatment' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $pest_control_treatment_font_awesome_icon_array = pest_control_treatment_font_awesome_icon_array();
                    foreach ($pest_control_treatment_font_awesome_icon_array as $pest_control_treatment_font_awesome_icon) {
                            $icon_class = $this->value() == $pest_control_treatment_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($pest_control_treatment_font_awesome_icon).'"></i>
                            <span class="pest-control-treatment-social-class">'.esc_attr($pest_control_treatment_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function pest_control_treatment_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'pest-control-treatment-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'pest_control_treatment_customizer_script' );

if(!function_exists('pest_control_treatment_font_awesome_icon_array')){
    function pest_control_treatment_font_awesome_icon_array(){
